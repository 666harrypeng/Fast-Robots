...
![debug_reading_case_code](/Fast-Robots/assets/images/lab5/debug_reading_case_code.png "debug_reading_case_code")

On my PC, the corresponding handler was modified as:

![handler_code](/Fast-Robots/assets/images/lab5/handler_code.png "handler_code")
...
![tof_update_rate](/Fast-Robots/assets/images/lab5/tof_update_rate.jpg "tof_update_rate")

![sample_rate_compare](/Fast-Robots/assets/images/lab5/sample_rate_compare.png "sample_rate_compare")
...
![pid_ini_code](/Fast-Robots/assets/images/lab5/pid_ini_code.png "pid_ini_code")
...
![01kp_error](/Fast-Robots/assets/images/lab5/01kp_error.png "01kp_error")

![01kp_pwm](/Fast-Robots/assets/images/lab5/01kp_pwm.png "01kp_pwm")

And the distance error and the PWM values for Kp=0.2 are:

![02kp_error](/Fast-Robots/assets/images/lab5/01kp_error.png "02kp_error")

![02kp_pwm](/Fast-Robots/assets/images/lab5/01kp_pwm.png "02kp_pwm")
...
![pd_error](/Fast-Robots/assets/images/lab5/pd_error.png "pd_error")

![pd_pid](/Fast-Robots/assets/images/lab5/pd_pid.png "pd_pid")

![pd_pwm](/Fast-Robots/assets/images/lab5/pd_pwm.png "pd_pwm")
...
![full_pid_error](/Fast-Robots/assets/images/lab5/full_pid_error.png "full_pid_error")

![full_pid_value](/Fast-Robots/assets/images/lab5/full_pid_value.png "full_pid_value")

![full_pid_pwm](/Fast-Robots/assets/images/lab5/full_pid_pwm.png "full_pid_pwm")
...
![pid_code_1](/Fast-Robots/assets/images/lab5/pid_code_1.png "pid_code_1")

![pid_code_2](/Fast-Robots/assets/images/lab5/pid_code_2.png "pid_code_2")
...
![extrapolation_code](/Fast-Robots/assets/images/lab5/extrapolation_code.png "extrapolation_code")
...
![no_extrapolation_error](/Fast-Robots/assets/images/lab5/no_extrapolation_error.png "no_extrapolation_error")

![no_extrapolation_pid](/Fast-Robots/assets/images/lab5/no_extrapolation_pid.png "no_extrapolation_pid")

![no_extrapolation_pwm](/Fast-Robots/assets/images/lab5/no_extrapolation_pwm.png "no_extrapolation_pwm")

***With Extrapolation***, the readings are:

![extrapolation_error](/Fast-Robots/assets/images/lab5/extrapolation_error.png "extrapolation_error")

![extrapolation_pid](/Fast-Robots/assets/images/lab5/extrapolation_pid.png "extrapolation_pid")

![extrapolation_pwm](/Fast-Robots/assets/images/lab5/extrapolation_pwm.png "extrapolation_pwm")
